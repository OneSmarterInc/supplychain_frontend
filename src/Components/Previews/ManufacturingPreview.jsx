...
const ManufacturingPreview = ({ ManufacturingDataPreview, toggleModal }) => {
  return (
    <div>
      <div
        id="default-modal"
            ...
            >
              ...
              <Tbody>
                {ManufacturingDataPreview &&
                  Object.keys(ManufacturingDataPreview).map((channel) => (
                    <Tr key={channel}>
                      <Td>
                        <strong>{channel}</strong>
                      </Td>
                      <Td>{ManufacturingDataPreview[channel].productZero}</Td>
                      <Td>{ManufacturingDataPreview[channel].hyperware}</Td>
                      <Td>{ManufacturingDataPreview[channel].metaware}</Td>
                    </Tr>
                  ))}
              </Tbody>
            </Table>
