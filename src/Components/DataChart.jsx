      ...
      <div className="flex flex-row w-[510px] justify-evenly">
        ...
        <div className="modal-start flex">
          ...
          <button
            ...
            className="h-10 w-28 bg-red-400 rounded-lg p-2 text-black text-center text-xl cursor-pointer  ease-in duration-150  place-items-start hover:cursor-pointer active:bg-violet-700 focus:bg-violet-500 active:outline-none hover:ring hover:ring-violet-400 mx-2 p-auto"
            type="button"
          >
            Preview
          </button>
          ...
          <div className="w-28 h-10 bg-green-400 rounded-lg p-2 text-black text-center text-xl cursor-pointer  ease-in duration-150  place-items-start hover:cursor-pointer active:bg-violet-700 focus:bg-violet-500 active:outline-none hover:ring hover:ring-violet-400 mx-2 p-auto">
            Submit
          </div>
        </div>
        {/* Modal ends */}

        <div className="w-28 h-10 bg-slate-400 rounded-lg p-2 text-black text-center text-xl cursor-pointer  ease-in duration-150  place-items-start hover:cursor-pointer active:bg-violet-700 focus:bg-violet-500 active:outline-none hover:ring hover:ring-violet-400 mx-2 p-auto">
          Reports
        </div>
      </div>
    </div>
