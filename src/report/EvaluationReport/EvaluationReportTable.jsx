...
const EvaluationReportTable = () => {
  ...
  return (
    <div>
      ...
      <table className="w-full text-start whitespace-nowrap">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.net_income_to_revenues_firm_3 < 0 ? "text-red-500" : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.net_income_to_revenues_worst < 0 ? "text-red-500" : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.net_income_to_revenues_average < 0
                  ? "text-red-500"
                  : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.net_income_to_revenues_best < 0 ? "text-red-500" : ""
              } `}
            >
          ...
          <tr>
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.change_in_net_income_to_revenues_firm_3 < 0
                  ? "text-red-500"
                  : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.change_in_net_income_to_revenues_worst < 0
                  ? "text-red-500"
                  : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.change_in_net_income_to_revenues_average < 0
                  ? "text-red-500"
                  : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.change_in_net_income_to_revenues_best < 0
                  ? "text-red-500"
                  : ""
              } `}
            >
          ...
          <tr>
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.return_on_assets_firm_3 < 0 ? "text-red-500" : ""
              } `}
            >
              {firmData.return_on_assets_firm_3}%
            </td>
            <td
              className={`border px-4 py-2 ${
                firmData.return_on_assets_worst < 0 ? "text-red-500" : ""
              } `}
            >
              {firmData.return_on_assets_worst}%
            </td>
            <td
              className={`border px-4 py-2 ${
                firmData.return_on_assets_average < 0 ? "text-red-500" : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.return_on_assets_best < 0 ? "text-red-500" : ""
              } `}
            >
              {firmData.return_on_assets_best}%
            </td>
          </tr>
          <tr>
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.net_asset_turns_firm_3 < 0 ? "text-red-500" : ""
              } `}
            >
              {firmData.net_asset_turns_firm_3}
            </td>
            <td
              className={`border px-4 py-2 ${
                firmData.net_asset_turns_worst < 0 ? "text-red-500" : ""
              } `}
            >
              {firmData.net_asset_turns_worst}
            </td>
            <td
              className={`border px-4 py-2 ${
                firmData.net_asset_turns_average < 0 ? "text-red-500" : ""
              } `}
            >
              {firmData.net_asset_turns_average}
            </td>
            <td
              className={`border px-4 py-2 ${
                firmData.net_asset_turns_best < 0 ? "text-red-500" : ""
              } `}
            >
              {firmData.net_asset_turns_best}
            </td>
          </tr>
          ...
          <tr>
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.inventory_turnover_firm_3 < 0 ? "text-red-500" : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.inventory_turnover_worst < 0 ? "text-red-500" : ""
              } `}
            >
              {firmData.inventory_turnover_worst}
            </td>
            <td
              className={`border px-4 py-2 ${
                firmData.inventory_turnover_average < 0 ? "text-red-500" : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.inventory_turnover_best < 0 ? "text-red-500" : ""
              } `}
            >
              {firmData.inventory_turnover_best}
            </td>
          </tr>
          <tr>
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.fill_rate_firm_3 < 0 ? "text-red-500" : ""
              } `}
            >
              {firmData.fill_rate_firm_3}%
            </td>
            <td
              className={`border px-4 py-2 ${
                firmData.fill_rate_worst < 0 ? "text-red-500" : ""
              } `}
            >
              {firmData.fill_rate_worst}%
            </td>
            <td
              className={`border px-4 py-2 ${
                firmData.fill_rate_average < 0 ? "text-red-500" : ""
              } `}
            >
              {firmData.fill_rate_average}%
            </td>
            <td
              className={`border px-4 py-2 ${
                firmData.fill_rate_best < 0 ? "text-red-500" : ""
              } `}
            >
              {firmData.fill_rate_best}%
            </td>
          </tr>
          <tr>
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.unplanned_production_firm_3 < 0 ? "text-red-500" : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.unplanned_production_worst < 0 ? "text-red-500" : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.unplanned_production_average < 0 ? "text-red-500" : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.unplanned_production_best < 0 ? "text-red-500" : ""
              } `}
            >
          ...
          <tr>
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.failure_rate_firm_3 < 0 ? "text-red-500" : ""
              } `}
            >
              {firmData.failure_rate_firm_3}%
            </td>
            <td
              className={`border px-4 py-2 ${
                firmData.failure_rate_worst < 0 ? "text-red-500" : ""
              } `}
            >
              {firmData.failure_rate_worst}%
            </td>
            <td
              className={`border px-4 py-2 ${
                firmData.failure_rate_average < 0 ? "text-red-500" : ""
              } `}
            >
              {firmData.failure_rate_average}%
            </td>
            <td
              className={`border px-4 py-2 ${
                firmData.failure_rate_best < 0 ? "text-red-500" : ""
              } `}
            >
              {firmData.failure_rate_best}%
            </td>
          </tr>
          <tr>
            <td className={`border px-4 py-2  `}>
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.controllable_procure_mfg_to_revenues_firm_3 < 0
                  ? "text-red-500"
                  : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.controllable_procure_mfg_to_revenues_worst < 0
                  ? "text-red-500"
                  : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.controllable_procure_mfg_to_revenues_average < 0
                  ? "text-red-500"
                  : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.controllable_procure_mfg_to_revenues_best < 0
                  ? "text-red-500"
                  : ""
              } `}
            >
          ...
          <tr>
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.transportation_expenses_per_unit_sold_firm_3 < 0
                  ? "text-red-500"
                  : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.transportation_expenses_per_unit_sold_worst < 0
                  ? "text-red-500"
                  : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.transportation_expenses_per_unit_sold_average < 0
                  ? "text-red-500"
                  : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.transportation_expenses_per_unit_sold_best < 0
                  ? "text-red-500"
                  : ""
              } `}
            >
          ...
          <tr>
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.forecasting_accuracy_firm_3 < 0 ? "text-red-500" : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.forecasting_accuracy_worst < 0 ? "text-red-500" : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.forecasting_accuracy_average < 0 ? "text-red-500" : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.forecasting_accuracy_best < 0 ? "text-red-500" : ""
              } `}
            >
          ...
          <tr>
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.marketing_service_to_revenues_firm_3 < 0
                  ? "text-red-500"
                  : ""
              } `}
            >
              {firmData.marketing_service_to_revenues_firm_3}%
            </td>
            <td
              className={`border px-4 py-2 ${
                firmData.marketing_service_to_revenues_worst < 0
                  ? "text-red-500"
                  : ""
              } `}
            >
              {firmData.marketing_service_to_revenues_worst}%
            </td>
            <td
              className={`border px-4 py-2 ${
                firmData.marketing_service_to_revenues_average < 0
                  ? "text-red-500"
                  : ""
              } `}
            >
              {firmData.marketing_service_to_revenues_average}%
            </td>
            <td
              className={`border px-4 py-2 ${
                firmData.marketing_service_to_revenues_best < 0
                  ? "text-red-500"
                  : ""
              } `}
            >
              {firmData.marketing_service_to_revenues_best}%
            </td>
          </tr>
          ...
          <tr>
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.change_in_market_share_firm_3 < 0 ? "text-red-500" : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.change_in_market_share_worst < 0 ? "text-red-500" : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.change_in_market_share_average < 0
                  ? "text-red-500"
                  : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.change_in_market_share_best < 0 ? "text-red-500" : ""
              } `}
            >
          ...
          <tr>
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.customer_satisfaction_firm_3 < 0 ? "text-red-500" : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.customer_satisfaction_worst < 0 ? "text-red-500" : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.customer_satisfaction_average < 0 ? "text-red-500" : ""
              } `}
            >
            ...
            <td
              className={`border px-4 py-2 ${
                firmData.customer_satisfaction_best < 0 ? "text-red-500" : ""
              } `}
            >
      ...
      <PDFDownloadLink
        document={<EvaluationReportSalesPDF firmData={firmData} />}
