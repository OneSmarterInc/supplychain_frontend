...
const UserSideLive = () => {
  ...
  // Get user data from localStorage with a fallback to an empty object
    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="p-4 pl-10">
          <p className="text-lg">
            You have not enrolled for any simulation yet. If you have a passcode, click on Join Now:
          </p>
        </div>
      )}
      <div className="h-100">
      ...
      <JoinNow refreshSimulations={getAllData} /> {/* Pass the function here */}
    </div>
  );
};
