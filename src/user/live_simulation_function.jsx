    ...
    <div className="flex h-80 bg-slate-200 justify-around items-center mx-10 rounded-lg border-2 border-neutral-600">
      <div className="info">
        <h2 className="text-3xl p-2 underline underline-offset-1">
          {batch} |
          <span className="text-3xl p-2">Current Quarter : {currentQuarter}</span>
        </h2>
        <p className='text-base p-2'>start Date {startDate} | End Date{endDate}</p>
        <div className="buttons my-2">
          <button className="w-32 h-10 rounded-lg bg-blue-600 text-white text-center p-2 mx-2 hover:bg-sky-950" onClick={handleSubmit}>
            Enter
          </button>
